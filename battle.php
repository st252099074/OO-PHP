            ...
            <div class="result-box center-block">
                <h3 class="text-center audiowide">
                    ...
                    <?php if ($battleResult->isThereAWinner()): ?>
                        <?php echo $battleResult->getWinningShips()->getName(); ?>
                    <?php else: ?>
                        Nobody
                    <?php endif; ?>
                </h3>
                <p class="text-center">
                    ...
                    <?php else: ?>
                        The <?php echo $battleResult['winningShips']->getName(); ?>
                        <?php if ($battleResult->wereJediPowersUsed()): ?>
                            used its Jedi Powers for a stunning victory!
                        <?php else: ?>
                            overpowered and destroyed the <?php echo $battleResult->getLosingShips()->getName(); ?>s
                        <?php endif; ?>
                    <?php endif; ?>
                </p>
                <h3>Ship Health</h3>
