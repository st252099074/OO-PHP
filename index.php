...
$ships[] = new BrokenShip('I am so broken');
                ...
                <div>
                    <form method="POST" action="/oop2/battle.php">
                        ...
                        <div class="text-center">
                            <label for="battle_tpe">Battle Type</label>
                            <select name="battle_type" id="battle_type" class="center-block form-control btn drp-dwn-width btn-default btn-lg dropdown-toggle">
                              <?php foreach ($battleTypes as $battleType => $sb): ?>
                                <option value="<?php echo $battleType ?>"><?php echo $sb; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <br>
